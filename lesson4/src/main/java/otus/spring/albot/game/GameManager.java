...
import otus.spring.albot.questionHandler.IQuestionHandlerFactory;
import otus.spring.albot.questionHandler.QuestionHandler;
import otus.spring.albot.util.message.IMessageHandler;
...
public class GameManager implements IGameManager {
    ...
    @Autowired
    public GameManager(
            IQuestionHandlerFactory factory, IMessageHandler messageHandler,
